...
func main() {
	...
	if err != nil {
		log.Fatal("Error Cnnecting to MONGODB", err)
	}
...
func getTodo(c *fiber.Ctx) error {
	...
	log.Println("cursor results: ", *cursor)
...
func updateTodo(c *fiber.Ctx) error {
	...
	if err != nil {
		return c.Status(400).JSON(fiber.Map{"error": "Invalid toodo ID"})
	}
